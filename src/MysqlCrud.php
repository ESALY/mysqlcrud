...
class MysqlCrud{
    ...
    //utilits
    //placeholder for where reqest
    public function where_placeholder($params){
        $options = array();
        ...
        return $placeholder = implode(" and ", $options);
    }

    //insert records
    public function insert_record($record = array(), $table)
    {
        ...
        $this->insert($table, $record); // Table name, column names and respective values
        //$res = $this->getResult();
    }
}